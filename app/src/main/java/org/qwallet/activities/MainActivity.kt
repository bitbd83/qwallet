...
import org.qwallet.activities.walletconnect.getWalletConnectIntent
...
import org.qwallet.ui.TransactionAdapterDirection
import org.qwallet.ui.TransactionRecyclerAdapter
import org.qwallet.ui.valueview.ValueViewController
import org.qwallet.util.copyToClipboard
import org.qwallet.util.isParityUnsignedTransactionJSON
import org.qwallet.util.isSignedTransactionJSON
import org.qwallet.util.isUnsignedTransactionJSON
...
class MainActivity : WallethActivity(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val incomingTransactionsAdapter = TransactionRecyclerAdapter(appDatabase, TransactionAdapterDirection.INCOMING, networkDefinitionProvider, exchangeRateProvider, settings)
        transaction_recycler_in.adapter = incomingTransactionsAdapter

        val outgoingTransactionsAdapter = TransactionRecyclerAdapter(appDatabase, TransactionAdapterDirection.OUTGOING, networkDefinitionProvider, exchangeRateProvider, settings)
