...
import org.qwallet.activities.walletconnect.WalletConnectConnectionActivity
import org.qwallet.data.config.Settings
import org.qwallet.data.networks.CurrentAddressProvider
import org.qwallet.data.tokens.isTokenTransfer
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (parsed831.isERC831()) {
            ...
            if (parsed831.prefix == "esm") {
                ...
                if (split?.size != 2) {
                    alert("Invalid request. " + intent.data.toString() + " If you think this should be valid - please drop ligi a mail (info@qpay.group).")
                    return
                }
